...
(
    ...
    idrecurso			INT 		NOT NULL,
    estado_entrega		CHAR(1) 	NOT NULL,  -- PENDIENTE / COMPLETADO 
    estado_devolucion	CHAR(1) 	NULL, 	   -- PENDIENTE / ATRASADO / RECIBIDO
	estado_equipo 		CHAR(1) 	NOT NULL,   -- BUENO - INTERMEDIO - MALO
    observaciones	VARCHAR(100) 	NULL,  		-- observaciones del equipo
    fotoestado 		VARCHAR(200) 	NULL,	
