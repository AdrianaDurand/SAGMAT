...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-05-2024 a las 06:09:33
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_solicitudes_registrar` (IN `_idsolicita` INT, IN `_idrecurso` INT, IN `_hora` TIME, IN `_cantidad` SMALLINT, IN `_fechasolicitud` DATE)   BEGIN
...
INSERT INTO `solicitudes` (`idsolicitud`, `idsolicita`, `idrecurso`, `hora`, `cantidad`, `fechasolicitud`) VALUES
(1, 4, 5, '08:00:00', 2, '2024-05-06');
