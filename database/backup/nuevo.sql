...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-06-2024 a las 19:23:46
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `registrar_prestamo1` (IN `p_iddetallesolicitud` INT, IN `p_idatiende` INT)   BEGIN
    ...
    VALUES (p_iddetallesolicitud, p_idatiende, 'Pendiente');
    ...
    -- Obtener el idrecurso del ejemplar
    SELECT idrecurso
    INTO v_idrecurso
    FROM recursos r
    JOIN ejemplares e ON r.idrecurso = e.iddetallerecepcion
    WHERE e.idejemplar = v_idejemplar;
...
(1, 1, 0, '2024-06-19 03:06:36', '2024-06-20 14:58:34', NULL),
...
(15, 15, 0, '2024-06-19 03:51:33', NULL, NULL),
