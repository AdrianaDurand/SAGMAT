...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-05-2024 a las 23:08:14
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_solicitudes_registrar` (IN `_idsolicita` INT, IN `_idtipo` INT, IN `_idubicaciondocente` INT, IN `_hora` TIME, IN `_cantidad` SMALLINT, IN `_fechasolicitud` DATE)   BEGIN
...
INSERT INTO `recepciones` (`idrecepcion`, `idusuario`, `idpersonal`, `fechayhoraregistro`, `fechayhorarecepcion`, `tipodocumento`, `nrodocumento`, `serie_doc`, `create_at`, `update_at`, `inactive_at`) VALUES
(1, 1, NULL, '2024-04-12 00:00:00', '2024-04-16 00:00:00', 'Boleta', '0004129', 'T0-150', '2024-05-10 14:25:40', NULL, NULL),
(2, 1, NULL, '2024-05-10 15:15:26', '2024-04-29 15:15:00', 'Boleta', '323', '2233', '2024-05-10 15:15:26', NULL, NULL),
(3, 1, NULL, '2024-05-10 15:18:29', '2024-05-09 15:18:00', 'Boleta', '1', '1', '2024-05-10 15:18:29', NULL, NULL),
(4, 1, NULL, '2024-05-10 15:58:57', '2024-05-06 15:58:00', 'Boleta', '12345678', '12345678', '2024-05-10 15:58:57', NULL, NULL);
...
ALTER TABLE `devoluciones`
  ...
  ADD KEY `fk_idprestamo_dv` (`idprestamo`),
...
--
ALTER TABLE `ejemplares`
  MODIFY `idejemplar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
ALTER TABLE `devoluciones`
  ...
  ADD CONSTRAINT `fk_idprestamo_dv` FOREIGN KEY (`idprestamo`) REFERENCES `prestamos` (`idprestamo`);
