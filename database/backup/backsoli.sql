...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-05-2024 a las 22:53:39
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_detallesolicitudes_registrar` (IN `_idsolicitud` INT, IN `_idejemplar` SMALLINT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_solicitudes_registrar` (IN `_idsolicita` INT, IN `_idtipo` INT, IN `_idubicaciondocente` INT, IN `_cantidad` INT, IN `_horainicio` TIME, IN `_horafin` TIME, IN `_fechasolicitud` DATE)   BEGIN
...
(1, 1, 3, 4, 4, '', '2024-05-23 17:22:43', NULL, NULL),
(2, 1, 3, 2, 2, '', '2024-05-23 18:50:36', NULL, NULL);
...
INSERT INTO `detsolicitudes` (`iddetallesolicitud`, `idsolicitud`, `idejemplar`, `create_at`, `update_at`, `inactive_at`) VALUES
(1, 1, 1, '2024-05-23 17:52:20', NULL, NULL),
(2, 1, 2, '2024-05-23 17:52:31', NULL, NULL),
(3, 3, 1, '2024-05-23 18:34:05', NULL, NULL),
(4, 4, 1, '2024-05-23 18:37:15', NULL, NULL),
(5, 5, 3, '2024-05-23 18:40:23', NULL, NULL),
(6, 5, 1, '2024-05-23 18:40:23', NULL, NULL);
...
(1, 1, 'AUD-15', 'AF-0001', 'Bueno', '2024-05-23 17:22:44', NULL, NULL, '0'),
(2, 1, 'AUD-19', 'AF-0002', 'Bueno', '2024-05-23 17:22:44', NULL, NULL, '0'),
(3, 1, 'AUD-13', 'AF-0003', 'Bueno', '2024-05-23 17:22:44', NULL, NULL, '0'),
(4, 1, 'AUD-18', 'AF-0004', 'Bueno', '2024-05-23 17:22:44', NULL, NULL, '0'),
(5, 2, NULL, 'AF-0005', 'Bueno', '2024-05-23 18:50:39', NULL, NULL, '0'),
(6, 2, NULL, 'AF-0006', 'Bueno', '2024-05-23 18:50:39', NULL, NULL, '0');
...
(1, 1, 1, 1, '2024-05-23 17:22:42', '2024-05-20 17:21:00', 'Boleta', '12345678', 'ABC-123', '2024-05-23 17:22:42', NULL, NULL);
...
(1, 1, 2, 1, '05:20:55', '08:00:20', 3, '2024-05-20', 0, '2024-05-23 17:52:08', NULL, NULL),
(2, 1, 2, 1, '19:26:00', '18:26:00', 2, '2024-05-23', 0, '2024-05-23 18:26:04', NULL, NULL),
(3, 1, 2, 1, '18:36:00', '21:34:00', 2, '2024-05-23', 0, '2024-05-23 18:34:05', NULL, NULL),
(4, 1, 2, 1, '18:39:00', '21:36:00', 2, '2024-05-24', 0, '2024-05-23 18:37:15', NULL, NULL),
(5, 1, 2, 1, '01:00:00', '13:00:00', 2, '2024-05-29', 0, '2024-05-23 18:40:23', NULL, NULL);
...
(1, 1, 0, '2024-05-22 02:44:04', NULL, NULL),
(2, 2, 0, '2024-05-22 02:48:28', NULL, NULL),
(3, 3, 6, '2024-05-22 02:55:20', NULL, NULL),
...
(12, 12, 0, '2024-05-22 19:11:01', NULL, NULL),
...
--
ALTER TABLE `detsolicitudes`
  MODIFY `iddetallesolicitud` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `ejemplares`
  MODIFY `idejemplar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
