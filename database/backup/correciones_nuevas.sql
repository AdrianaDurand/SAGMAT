...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-06-2024 a las 08:54:43
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_listado_detsoli` (IN `_idsolicitud` INT)   BEGIN
    ...
    JOIN 
        ejemplares e ON ds.idejemplar = e.idejemplar
    JOIN 
        recursos r ON r.idtipo = ds.idtipo -- Unimos con la tabla recursos mediante el idtipo
    JOIN 
        stock s ON s.idrecurso = r.idrecurso -- Unimos con la tabla stock mediante el idrecurso
    JOIN
        (SELECT 
            idsolicitud,
...
(13, 9, 2, 1, 1, 0, '2024-05-30 16:04:21', NULL, NULL),
(14, 10, 1, 3, 2, 0, '2024-05-30 16:07:14', NULL, NULL),
(15, 10, 2, 2, 2, 0, '2024-05-30 16:07:14', NULL, NULL);
...
(9, 1, 1, '19:04:00', '19:04:00', '2024-05-31', 0, '2024-05-30 16:04:21', NULL, NULL),
(10, 1, 1, '19:06:00', '20:06:00', '2024-06-01', 0, '2024-05-30 16:07:14', NULL, NULL);
...
(1, 1, 21, '2024-05-22 02:44:04', NULL, NULL),
(2, 2, 16, '2024-05-22 02:48:28', NULL, NULL),
(3, 3, 18, '2024-05-22 02:55:20', NULL, NULL),
...
(2, 2, 1, '$2y$10$srVoggtUq/0Vta0iJI/nWeaa4sMvKHv3RwWCmuO6CJvqU.rtJtuHi'),
...
--
ALTER TABLE `detsolicitudes`
  MODIFY `iddetallesolicitud` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
