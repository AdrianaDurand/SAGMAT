...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-04-2024 a las 10:38:07
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_addejemplar` (IN `_idrecepcion` INT, IN `_idrecurso` INT, IN `_nro_serie` VARCHAR(50), IN `_nro_equipo` VARCHAR(20))   BEGIN 
...
--
ALTER TABLE `recepciones`
  MODIFY `idrecepcion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
