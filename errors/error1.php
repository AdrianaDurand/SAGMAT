...
<body>
    <div id="wrapper">
        ...
        <!-- Modal -->
        <div class="modal fade" id="modal-reprogranar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="" autocomplete="off" id="form-reprogranar" class="needs-validation" novalidate>
                            <div class="row">
                                <div class="col-md-12">
                    ...
                    <div class="modal-footer d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-outline-danger flex-fill" data-bs-dismiss="modal"><i class="fi-sr-eye"></i>Cancelar</button>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function listar() {
                ...
                fetch(`../../controllers/prestamo.controller.php`, {
                    ...
                    .then(datos => {
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="triggerId">
                                        ...
                                        <button class="dropdown-item reprogramar" data-idprestamo="${element.idsolicitud}" type="button" data-bs-target="#modal-reprogranar" data-bs-toggle="modal"><i class="fa-solid fa-clock" style="color: #f60909;"></i> Reprogramar</button>                                               
                                    </div>
                                </div>
                            </td>
                                </tr>
                        ...
                        document.querySelectorAll('.dropdown-item.reprogramar').forEach(button => {
            ...
            function todo(idsolicitud) {
                ...
                fetch(`../../controllers/prestamo.controller.php`, {
                    ...
                    .then(respuesta => respuesta.json())
                    .then(datosRecibidos => {
                        // Asumiendo que datosRecibidos es un objeto con la estructura devuelta por el procedimiento almacenado
                        console.log(datosRecibidos);

                        // Asignar los valores recibidos a los inputs del modal
                        document.getElementById("horainicio").value = datosRecibidos.horainicio;
                        document.getElementById("horafin").value = datosRecibidos.horafin;
                        const selectUbicacion = document.getElementById("idubicaciondocente");
                            // Aquí asumes que el nombre de la ubicación está en el primer option
                            selectUbicacion.options[0].text = datosRecibidos.nombre_ubicacion;
