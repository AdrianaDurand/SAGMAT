                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown" style="display: flex;">
                                                ...
                                                <button  style="width: 30px; background-color: transparent;" class="dropdown-item eliminarp" data-idprestamo="${element.idsolicitud}" data-idpersona='${element.idpersona}' type="button">
                                                </button>  
                                            </div>
                                        </td>
                                    </tr>
