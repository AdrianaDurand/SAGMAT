            ...
            <div class="row justify-content-center">
              <div class="col-md-8">
                ...
                <div class="input-group mb-3 caja">
                  ...
                  <input type="date" class="form-control" aria-describedby="fechainicio" id="startDate">
                  <span class="input-group-text" style="height: 38px;">Hasta</span>
                  <input type="date" class="form-control" aria-describedby="fechainicio" id="endDate">
