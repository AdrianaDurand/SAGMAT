        ...
        <script>
            document.addEventListener("DOMContentLoaded", () => {
                ...
                function registrar(){
                    ...
                    parametros.append('idprestamo', )
                    parametros.append('observacion', $('#observaciones').value)
                    parametros.append('estadodevolucion', $('#estadodevolucion').value)
                    fetch(`../../controllers/devolucion.controller.php`,{
                        method:"POST",
                        body: parametros
                    })
                    .then(respuesta => respuesta.json())
                    .then(datos =>{
                        if (datos.iddevolucion > 0) {
                            console.log(`Devolución registrada con ID: ${datos.iddevolucion}`);
                        }
                    })
                    .catch(e =>{
                        console.error(e)
