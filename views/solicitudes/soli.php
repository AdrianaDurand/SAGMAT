...
<head>
    ...
    <link rel="icon" type="../../images/icons" href="../../images/icons/solicitudes.png" />
                ...
                <div class="col-md-12 text-center">
                    <div class="m-4">
                        <h2 class="fw-bolder d-inline-block">
                            <img src="../../images/icons/solicitudes.png" alt="Imagen de Solicitudes" style="height: 2.5em; width: 2.5em; margin-right: 0.5em;"> SOLICITUDES DE PRÉSTAMOS
                        </h2>
                    </div>
                </div>
            </div>
